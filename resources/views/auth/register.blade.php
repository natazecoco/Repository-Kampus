...
<body class="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.16),_transparent_24%),linear-gradient(135deg,_#f8fbff_0%,_#eef4ff_100%)] flex items-center justify-center px-4 py-10">
    <div class="w-full max-w-xl rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-[0_20px_60px_-20px_rgba(15,23,42,0.35)] backdrop-blur">
        <div class="mb-8 text-center">
            ...
            <p class="mt-2 text-sm text-slate-500">Buat akun mahasiswa dengan NPM sebagai identitas utama.</p>
        </div>
